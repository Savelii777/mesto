...
function closeByEsc(evt) {
  if (evt.key === 'Escape') {
    ...
    {
      profileValidation._removeFormErrors(nameInput, jobInput, popupProfile)
    }
    else{
      imageValidation._removeFormErrors(imageNameInput, imageLinkInput, popupImage)
...
// };
// //Добавление карточки
function addCard(element, template) {
